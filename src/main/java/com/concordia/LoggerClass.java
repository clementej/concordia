    ...
    public class LoggerClass {
        ...
        public void printTeam(Team team){
            ...
            for (Player player: team.getPlayers())
                System.out.println("/ Integrated by" + "Player # " + counter++ + " " + player.getFirstName() + " " + player.getLastName()+" ["+"playing the position: "+player.getPosition().name()+"; "+"and his birth date is: "
